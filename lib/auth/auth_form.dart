...
class _AuthFormState extends State<AuthForm> with SingleTickerProviderStateMixin {
  ...
  var _userName = '';
  var _userPassword = '';
  TextEditingController password =  TextEditingController() ; // for confirmation in register
  ...
  void _trySubmit() {
    final isValid =  _isLogin ? _formKey.currentState!.validate() : _rFormKey.currentState!.validate();
    ...
    return Stack(
        children: [
          ...
          CancelButton(
            ...
            size: size,
            animationController: animationController,
            tapEvent: _isLogin ? null : () { // returning null to disable the button
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(decoration: BoxDecoration(color: Theme.of(context).backgroundColor, borderRadius: BorderRadius.all(Radius.circular(size.width * 1))),height: size.height * 0.25,child: Image.asset('assets/images/login.png',fit:  BoxFit.cover,)),
      ...
      child: TextFormField(
          ...
          border: InputBorder.none
                 ...
                 Row(mainAxisAlignment:  MainAxisAlignment.end,children: [Padding(
                   ...
                   child: TextButton(onPressed: (){Navigator.of(context).pushNamed(MyRoutes.forgotPassRoute);}, child: Text('Forgot Password?',textAlign: TextAlign.end,style: TextStyle(color: Theme.of(context).colorScheme.secondary,fontWeight: FontWeight.bold),)),
                 )],),
                  // SizedBox(height: size.height * 0.01),
            
                widget.isLoading ?  CircularProgressIndicator(color: Theme.of(context).colorScheme.secondary) :   RoundedButton(title: 'LOGIN', trySubmit: _trySubmit),
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(size.width * 1))),height: size.height * 0.25,child:Image.asset('assets/images/register.png',fit: BoxFit.cover,),),
     ...
     child:  TextFormField(
                 ...
                 border: InputBorder.none
                  ...
                  widget.isLoading ?  CircularProgressIndicator(color: Theme.of(context).colorScheme.secondary,) : RoundedButton(title: 'SIGN UP', trySubmit: _trySubmit),
